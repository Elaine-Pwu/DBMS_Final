...
<body>
    ...
    <h1>您的動作已成功執行</h1>
    <h2>請選擇下一個動作</h2>
    <button class = "button_add" onclick="window.location.href='manager_build.jsp'">建立班表</button>
    ...
    <button class = "button_back" onclick="window.location.href='manager_page.jsp'">回主功能選單</button>
